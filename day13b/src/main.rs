...
fn main() {
    ...
    for line in input.lines() {
        ...
        happinesses.entry("you").or_insert_with(HashMap::new).insert(right, 0);
        happinesses.entry(left).or_insert_with(HashMap::new).insert("you", 0);
    }

    println!("{}", find_max("you", &happinesses, &mut ["you"].iter().cloned().collect(), "you", 0));
}
